<?php
class HubCo_Brand_Adminhtml_BrandController
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $brandBlock = $this->getLayout()
            ->createBlock('hubco_brand_adminhtml/brand');
    ...
    public function editAction()
    {
         ...
         */
        $brand = Mage::getModel('hubco_brand/brand');
        ...
        $brandEditBlock = $this->getLayout()->createBlock(
            'hubco_brand_adminhtml/brand_edit'
        );
